jQuery(document).ready(function($) {
    ...
    function detectAndApplyTheme() {
        ...
        // 优先适配WordPress主题，总是添加theme-adaptive类来覆盖系统深色模式
        container.addClass('theme-adaptive');
        
        // 检测是否为浅色主题
        const isLightTheme = bodyBg && (
        ...
        if (isLightTheme) {
            ...
            computedStyles = {
                ...
                linkColor: $('a').first().css('color') || '#4fc3f7',
                borderColor: rgba2hex(adjustBrightness(textColor, -0.5)) || '#444444',
                borderLightColor: '#333333',
                bgColor: bodyBg || '#1a1a1a'
            };
        }
        ...
        container.css({
            ...
            '--srs-border-light-color': computedStyles.borderLightColor,
            '--srs-bg-color': computedStyles.bgColor
        });
    }
